...
describe('data', () => {
  ...
  describe('data.getAllChampsTags', () => {
    it('debería ser una función', () => {
      assert.equal(typeof window.data.getAllChampsTags, 'function');
    });

    it('debería retornar un array de los tags de todos los campeones', () => {
      assert.equal(window.data.getAllChampsTags(dataChamps), outputdataChamps);
    });
  });
});
...
const outputdataChamps1 = ['Fighter', 'Tank', 'Mage', 'Assassin', 'Assassin'];
...
describe('data', () => {
  ...
  describe('data.getAllChampsTags', () => {
    ...
    it('debería retornar un array de los tags de todos los campeones', () => {
      assert.equal(window.data.getAllChampsTags(dataChamps1), outputdataChamps1);
    });
  });
});
